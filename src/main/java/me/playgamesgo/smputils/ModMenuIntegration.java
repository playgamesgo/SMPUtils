        ...
        return parentScreen -> {
            ConfigCategory.Builder builder = ConfigCategory.createBuilder()
                    ...
                    .group(OptionGroup.createBuilder()
                            ...
                            .option(Option.<Config.MiniMapPosition>createBuilder()
                                    .name(Component.literal("Minimap Position"))
                                    .description(OptionDescription.of(Component.literal("The position of the minimap on the screen, can be TOP_LEFT, TOP_RIGHT, BOTTOM_LEFT, or BOTTOM_RIGHT.")))
                            ...
                            .option(Option.<Config.MapView>createBuilder()
                                    .name(Component.literal("Map View"))
                                    .description(OptionDescription.of(Component.literal("The view mode of the map, can be PERSPECTIVE or FLAT.")))
                                    .binding(Config.getMapView(), Config::getMapView, Config::setMapView)
                                    .controller(enumOption -> EnumControllerBuilder.create(enumOption)
                                            .enumClass(Config.MapView.class))
                                    .build())
                            .option(Option.<Integer>createBuilder()
                                    .name(Component.literal("Minimap width"))
            ...
            if (FabricLoader.getInstance().isModLoaded("flashback")) {
                builder.group(OptionGroup.createBuilder()
                        .name(Component.literal("Flashback"))
                        .option(Option.<Boolean>createBuilder()
                ...
                builder.group(ListOption.<String>createBuilder()
                        .name(Component.literal("Flashback Servers"))
                        .description(OptionDescription.createBuilder()
            ...
            return YetAnotherConfigLib.createBuilder()
                    .title(Component.literal("SMPUtils Config"))
